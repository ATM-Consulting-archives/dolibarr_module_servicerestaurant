...
?>
      ...
      <div class="main-wrap">
          ...
          <div class="sidebar">
            ...
            if($T_Order!= array())
            {
                echo '<a href="saisieCommande.php?fk_categorie=0&fk_table='.$fk_table.'" name="Résumé"><li>Résumé</li></a>';
            }
            ...
            foreach($categories as $cat)
            {
                ...
                echo "<a href=\"saisieCommande.php?fk_categorie=$cat&fk_table=$fk_table\" name=\"$id_categorie\"><li>$label_categorie</li></a>";
            }
            ?>
            </ul>
          </div>
                    ...
                    ?>
                      ...
                      <div class="col-lg-4 col-sm-12">
                        <div class="col-lg-4 col-sm-4 moins" style="cursor: pointer; background-color: #3c8eb9; height: 120px; font-size: 5vmin; text-align: center; vertical-align: middle; line-height: 120px;">
                          <a href="saisieCommande.php?fk_categorie=0&action=rem&fk_product=<?php echo $id_product; ?>&fk_table=<?php echo $fk_table; ?>">-</a>
                       </div>
                        ...
                        <div id="plus" class="col-lg-4 col-sm-4 plus" style="cursor: pointer; background-color: #3c8eb9; height: 120px; font-size: 5vmin; text-align: center; vertical-align: middle; line-height: 120px;">
                          <a href="saisieCommande.php?fk_categorie=0&action=add&fk_product=<?php echo $id_product; ?>&fk_table=<?php echo $fk_table; ?>">+</a>
                        </div>
                      </div>
                    </section>
                    <?php
                ...
                if($fk_categorie == $categorie->id) {
                    ...
                    foreach($Tproduct as $product_id)
                    {
                        ...
                        ?>
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <div class="col-lg-4 col-sm-4 moins" style="cursor: pointer; background-color: #3c8eb9; height: 120px; font-size: 5vmin; text-align: center; vertical-align: middle; line-height: 120px;">
                                        <a href="saisieCommande.php?fk_categorie=<?php echo $fk_categorie; ?>&action=rem&fk_product=<?php echo $id_product; ?>&fk_table=<?php echo $fk_table; ?>">-</a>
                                </div>
                                <div class="col-lg-4 col-sm-4 count" style="background-color: white; height: 120px; font-size: 5vmin; text-align: center; vertical-align: middle; line-height: 120px;">
                                    <?php echo $productQtyFromOrder;?>
                                </div>
                                <div id="plus" class="col-lg-4 col-sm-4 plus" style="cursor: pointer; background-color: #3c8eb9; height: 120px; font-size: 5vmin; text-align: center; vertical-align: middle; line-height: 120px;">
                                    <a href="saisieCommande.php?fk_categorie=<?php echo $fk_categorie; ?>&action=add&fk_product=<?php echo $id_product; ?>&fk_table=<?php echo $fk_table; ?>">+</a>
                                </div>
                            </div>
                        </section>
                        <?php
