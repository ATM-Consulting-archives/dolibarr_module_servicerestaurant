...
/**
 * 	\file		admin/servicerestaurant.php
...
require_once '../lib/servicerestaurant.lib.php';
 ...
 * View
 */
$page_name = "servicerestaurantSetup";
...
$head = servicerestaurantAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104034Name"),
    0,
